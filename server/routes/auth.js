...
router.delete("/delete/utility/:utility_id", deleteUtility);
...
// router.get("/getTotalTenants", verifyToken, getTotalTenants);
...
router.post("/editUtility/:utility_id", updateUtility);
